    ...
    return {
        ...
        "controls": {
            ...
            "selection": "\"selection\": {\"model\": \"portfolio_model\", "
                         ...
                         "limit stay on the binding. The control on "
                         "the page is that dropdown. A new grain is a "
                         "new binding in report.json, then a rebuild. "
                         "A number on the page is a value figure beside "
                         "its fingerprint.",
